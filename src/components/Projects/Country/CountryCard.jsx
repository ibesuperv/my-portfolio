                            ...
                            <article className='c-details'>
                                ...
                                <ul className='borders'>
                                    {item.borders.map((border,index)=>(
                                        <li key={index} className=''>{border}</li>
                                    ))}
                                </ul>
                                </>)}
                                <Link to="/country" className='btn hover:bg-black hover:text-white hover:border-2 border-2 hover:border-white transition-all duration-200 ' > &larr; Back</Link>
                            </article>
                        </div>
                    ))
                }
